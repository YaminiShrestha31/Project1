...
public class ADD_CUSTOMERS_DETAILS extends JFrame{ //Third Frame

   
    JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;

        public ADD_CUSTOMERS_DETAILS(){
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlineereservationsystem/icons/customer.png"));
